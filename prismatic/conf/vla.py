...
class VLAConfig(ChoiceRegistry):
    ...
    enable_tf32: bool = True                        # Enable TF32 Acceleration (for Ampere GPUs)
    ...
    # fmt: on
    co_training_data_mix: str = None                 # Co-training Data Mixture (if applicable)
...
# = [1 GPU] Fast Iteration =>> DINO-SigLIP 224px + RT-1 =
@dataclass
class Exp_DinoSigLIP_224px_RT_1_Debug_Cotraining_All(Exp_SigLIP_224px_Bridge):
    vla_id: str = "prism-dinosiglip-224px+mx-rt_1_cot_all_debug"
    base_vlm: Union[str, Path] = "prism-dinosiglip-224px+7b"

    data_mix: str = "rt_1"
    co_training_data_mix: str = "all"
    
    epochs: int = 50
    lr_scheduler_type: str = "linear-warmup+cosine-decay"
        
    expected_world_size: int = 1
    global_batch_size: int = 26
    per_device_batch_size: int = 26


@dataclass
class Exp_DinoSigLIP_224px_RT_1_2_Cotraining_All(Exp_SigLIP_224px_Bridge):
    vla_id: str = "prism-dinosiglip-224px+mx-rt_1_cot_all_2"
    base_vlm: Union[str, Path] = "prism-dinosiglip-224px+7b"
    ...
    global_batch_size: int = 52
    per_device_batch_size: int = 26

@dataclass
class Exp_Pi_224px_RT_1_4_Cotraining_All(Exp_SigLIP_224px_Bridge):
    vla_id: str = "pi-0-224px-rt_1_cotraining+robopoint_st_4"
    base_vlm: Union[str, Path] = "paligemma-224px+3b"

    data_mix: str = "rt_1"
    co_training_data_mix: str = "all+trace"
...
# = [4 GPU] Fast Iteration =>> DINO-SigLIP 224px + RT-1 =
@dataclass
class Exp_DinoSigLIP_224px_RT_1_4_Cotraining_All(Exp_SigLIP_224px_Bridge):
    vla_id: str = "prism-dinosiglip-224px+mx-rt_1_cotraining_st_4"
    base_vlm: Union[str, Path] = "prism-dinosiglip-224px+7b"
...
@dataclass
class Exp_DinoSigLIP_224px_RT_1_4_Cotraining_VLM(Exp_SigLIP_224px_Bridge):
    vla_id: str = "prism-dinosiglip-224px+mx-rt_1_cotraining_vlm_st_4"
    base_vlm: Union[str, Path] = "prism-dinosiglip-224px+7b"

    data_mix: str = "rt_1"
    co_training_data_mix: str = "vlm"
...
@dataclass
class Exp_DinoSigLIP_224px_RT_1_4_Cotraining_All_Vis(Exp_SigLIP_224px_Bridge):
    vla_id: str = "prism-dinosiglip-224px+mx-rt_1_cotraining+robopoint_dino_freeze_st_4"
    base_vlm: Union[str, Path] = "prism-dinosiglip-224px+7b"
...
@dataclass
class Exp_DinoSigLIP_224px_RT_1_8_Cotraining_All_Vis(Exp_SigLIP_224px_Bridge):
    vla_id: str = "prism-dinosiglip-224px+mx-rt_1_cotraining+robopoint_st_8"
    base_vlm: Union[str, Path] = "prism-dinosiglip-224px+7b"
...
@dataclass
class Exp_DinoSigLIP_224px_Bridge_4_Cotraining_All_Vis(Exp_SigLIP_224px_Bridge):
    vla_id: str = "prism-dinosiglip-224px+mx-bridge_cotraining+robopoint_st_4"
    base_vlm: Union[str, Path] = "prism-dinosiglip-224px+7b"
...
@dataclass
class Exp_DinoSigLIP_224px_RT_1_4(Exp_SigLIP_224px_Bridge):
    vla_id: str = "prism-dinosiglip-224px+mx-rt_1_4"
    base_vlm: Union[str, Path] = "prism-dinosiglip-224px+7b"
...
# = [8 GPU] Fast Iteration =>> DINO-SigLIP 224px + RT-1 =
@dataclass
class Exp_DinoSigLIP_224px_RT_1_8(Exp_SigLIP_224px_Bridge):
    vla_id: str = "prism-dinosiglip-224px+mx-rt_1_8"
    base_vlm: Union[str, Path] = "prism-dinosiglip-224px+7b"
...
# = [16 GPU] Fast Iteration =>> DINO-SigLIP 224px + RT-1 =
@dataclass
class Exp_DinoSigLIP_224px_RT_1_16(Exp_SigLIP_224px_Bridge):
    vla_id: str = "prism-dinosiglip-224px+mx-rt_1_16"
    base_vlm: Union[str, Path] = "prism-dinosiglip-224px+7b"
...
# = [32 GPU] Fast Iteration =>> DINO-SigLIP 224px + RT-1 =
@dataclass
class Exp_DinoSigLIP_224px_RT_1_32(Exp_DinoSigLIP_224px_RT_1_16):
    vla_id: str = "prism-dinosiglip-224px+mx-rt_1_32"
    
    expected_world_size: int = 32
    global_batch_size: int = 1024


# = [2 GPU] Fast Iteration =>> DINO-SigLIP 224px + RT-1 =
@dataclass
class Exp_DinoSigLIP_224px_RT_1_Debug(Exp_SigLIP_224px_Bridge):
    vla_id: str = "prism-dinosiglip-224px+mx-rt_1-debug"
    base_vlm: Union[str, Path] = "prism-dinosiglip-224px+7b"
...
# = [16 GPU] Fast Iteration =>> DINO-SigLIP 224px + Bridge =
@dataclass
class Exp_DinoSigLIP_224px_Bridge_16(Exp_DinoSigLIP_224px_RT_1_16):
    vla_id: str = "prism-dinosiglip-224px+mx-bridge_16"
    data_mix: str = "bridge"
...
class VLARegistry(Enum):
    DINOSIGLIP_224PX_MX_RT_1_DEBUG = Exp_DinoSigLIP_224px_RT_1_Debug
    DINOSIGLIP_224PX_MX_RT_1_DEBUG_COTRAINING_ALL = Exp_DinoSigLIP_224px_RT_1_Debug_Cotraining_All
    DINOSIGLIP_224PX_MX_RT_1_2_COTRAINING_ALL = Exp_DinoSigLIP_224px_RT_1_2_Cotraining_All
    DINOSIGLIP_224PX_MX_RT_1_4_COTRAINING_ALL = Exp_DinoSigLIP_224px_RT_1_4_Cotraining_All
    DINOSIGLIP_224PX_MX_RT_1_8 = Exp_DinoSigLIP_224px_RT_1_8
    DINOSIGLIP_224PX_MX_RT_1_4 = Exp_DinoSigLIP_224px_RT_1_4
    DINOSIGLIP_224PX_MX_RT_1_16 = Exp_DinoSigLIP_224px_RT_1_16
    DINOSIGLIP_224PX_MX_RT_1_32 = Exp_DinoSigLIP_224px_RT_1_32
    DINOSIGLIP_224PX_MX_BRIDGE_4_COTRAINING_ALL_VIS = Exp_DinoSigLIP_224px_Bridge_4_Cotraining_All_Vis
    DINOSIGLIP_224px_MX_BRIDGE_16 = Exp_DinoSigLIP_224px_Bridge_16
    DINOSIGLIP_224PX_MX_RT_1_4_COTRAINING_VLM = Exp_DinoSigLIP_224px_RT_1_4_Cotraining_VLM

    # RoboPoint Configurations
    DINOSIGLIP_224PX_MX_RT_1_8_COTRAINING_ROBOPOINT = Exp_DinoSigLIP_224px_RT_1_8_Cotraining_All_Vis
    DINOSIGLIP_224PX_MX_RT_1_4_COTRAINING_ROBOPOINT = Exp_DinoSigLIP_224px_RT_1_4_Cotraining_All_Vis
