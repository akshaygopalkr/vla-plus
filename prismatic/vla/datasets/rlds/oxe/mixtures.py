...
COTRAINING_NAMED_MIXTURES: Dict[str, List[str]] = {

    "vlm": [
        "llava_data_filtered",
        "llava_onevision_data_filtered"
    ],
    "all": [
        "llava_data_filtered",
        "vqasynth_spacellava_filtered",
        "llava_onevision_data_filtered",
    ],
    "all+trace":[
        "llava_data_filtered",
    ...
    "llava_llava_onevision": [
        "llava_data_filtered",
        "llava_onevision_data_filtered",
    ],
    "vqasynth_llava_onevision": [
        "vqasynth_spacellava_filtered",
        "llava_onevision_data_filtered",
    ]
}
...
OXE_NAMED_MIXTURES: Dict[str, List[Tuple[str, float]]] = {
    # === Bridge V2 Dataset ===
    "bridge": [
        # ("bridge", 1.0),                                    # Version of Bridge V2 in Open-X GCP Bucket
